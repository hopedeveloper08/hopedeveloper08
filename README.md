...
<p align="center">
    <img src="https://skillicons.dev/icons?i=react,python,django,&perline=3" />
</p>
...
<p align="center">
    <img src="https://skillicons.dev/icons?i=html,css,bootstrap,js,typescript&perline=7" />
</p>
    ...
    <g class="stagger" style="animation-delay: 450ms">
      ...
      <text x="215" y="34" class="lang-name">68.00%</text>
      
    <svg width="205" x="0" y="25">
      <rect rx="5" ry="5" x="0" y="0" width="205" height="8" fill="#ddd"></rect>
      <svg data-testid="lang-progress" width="68%">
        <rect
            height="8"
            fill="#f1e05a"
            rx="5" ry="5" x="0" y="0"
    ...
    <g class="stagger" style="animation-delay: 600ms">
      ...
      <text x="215" y="34" class="lang-name">18.21%</text>
      
    <svg width="205" x="0" y="25">
      <rect rx="5" ry="5" x="0" y="0" width="205" height="8" fill="#ddd"></rect>
      <svg data-testid="lang-progress" width="18.21%">
        <rect
            height="8"
            fill="#563d7c"
            rx="5" ry="5" x="0" y="0"
    ...
    <g class="stagger" style="animation-delay: 900ms">
      ...
      <text x="215" y="34" class="lang-name">3.88%</text>
      
    <svg width="205" x="0" y="25">
      <rect rx="5" ry="5" x="0" y="0" width="205" height="8" fill="#ddd"></rect>
      <svg data-testid="lang-progress" width="3.88%">
        <rect
            height="8"
            fill="#c6538c"
            rx="5" ry="5" x="0" y="0"
